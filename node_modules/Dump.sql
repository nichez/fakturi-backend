CREATE DATABASE  IF NOT EXISTS `testExpress` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `testExpress`;
...
CREATE TABLE `artikli` (
  `shifra` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`shifra`),
  KEY `tarifen_broj_ddv` (`tarifen_broj_ddv`),
  CONSTRAINT `tarifen_broj_ddv` FOREIGN KEY (`tarifen_broj_ddv`) REFERENCES `tarifen_broj` (`id`)
...
CREATE TABLE `promet_header` (
  `shifra` bigint(20) NOT NULL,
  `datum` date DEFAULT NULL,
  `iznos` bigint(20) DEFAULT NULL,
  `vid` enum('PR','FK','SM') DEFAULT NULL,
  `partner` bigint(20) DEFAULT NULL,
  `rbs` bigint(20) DEFAULT NULL,
  `godina` year(4) DEFAULT NULL,
  `iznosBezDdv` bigint(20) DEFAULT NULL,
  `vkupnoDdv` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`shifra`),
  KEY `partner` (`partner`),
  CONSTRAINT `promet_header_ibfk_1` FOREIGN KEY (`partner`) REFERENCES `delovni_partneri` (`shifra`) ON DELETE CASCADE
...
CREATE TABLE `stavki` (
  ...
  `artikal` bigint(20) DEFAULT NULL,
  ...
  `brojNaPromet` bigint(20) DEFAULT NULL,
  `partner` bigint(20) DEFAULT NULL,
  `datum` date DEFAULT NULL,
  PRIMARY KEY (`shifra`),
  KEY `rbs` (`rbs`),
  KEY `brojNaPromet` (`brojNaPromet`),
  KEY `artikal` (`artikal`),
  KEY `partner` (`partner`),
  CONSTRAINT `stavki_ibfk_3` FOREIGN KEY (`brojNaPromet`) REFERENCES `promet_header` (`shifra`) ON DELETE CASCADE,
  CONSTRAINT `stavki_ibfk_5` FOREIGN KEY (`artikal`) REFERENCES `artikli` (`shifra`),
  CONSTRAINT `stavki_ibfk_6` FOREIGN KEY (`partner`) REFERENCES `delovni_partneri` (`shifra`)
...
--
-- Table structure for table `tarifen_broj`
--

DROP TABLE IF EXISTS `tarifen_broj`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tarifen_broj` (
...
-- Dump completed on 2021-11-22  9:50:52
